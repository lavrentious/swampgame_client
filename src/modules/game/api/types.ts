...
export enum WsEventType {
  ...
  PLAYER_CREATED_LOBBY = "PLAYER_CREATED_LOBBY",
  PLAYER_JOINED_LOBBY = "PLAYER_JOINED_LOBBY",
  PLAYER_LEFT_LOBBY = "PLAYER_LEFT_LOBBY",

  GAME_FINISHED = "GAME_FINISHED",
  GAME_STARTED = "GAME_STARTED",
  GAME_FIRST_FOLD_PROCESSED = "GAME_FIRST_FOLD_PROCESSED",
...
export type WsEventPayloadMap = {
  ...
  [WsEventType.PLAYER_CREATED_LOBBY]: { lobbyId: number };

  [WsEventType.GAME_STARTED]: GameStartedPayload;
  [WsEventType.GAME_FIRST_FOLD_PROCESSED]: StringPayload;
